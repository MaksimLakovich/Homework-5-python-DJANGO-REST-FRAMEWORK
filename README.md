...
[8. Получение ключей .env](#title8) / 
[9. Описание файла .flake8](#title9) / 
[10. Описание файла mypy.ini](#title10) / 
...
# <a id="title9">9. Описание файла .flake8</a> 
```angelscript
[flake8]
max-line-length = 119
ignore = E203, W503
...
# <a id="title10">10. Описание файла mypy.ini</a> 
```ini
