...
[11. Загрузка тестовых данных](#title11) / 
[12. Тестирование приложения](#title12) /
...
1) Интеграция с платежной системой STRIPE (https://docs.stripe.com/api):
   ...
   - функция `create_product_course(paid_course)` - создание продукта (курс) в платежной системе Stripe.
   ...
   - функция `create_price(product_id, payment_amount)` - создание цены продукта в платежной системе Stripe. Достаточно в функцию передать только product_id и payment_amount.
   ...
   - функция `create_session(price_id)` - создание сессии для получения ссылки на оплату продукта. Достаточно в функцию передать только price_id, а остальное можно захардкодить (quantity=1 и т.д.).
...
# <a id="title11">11. Загрузка тестовых данных</a>
...
# <a id="title12">12. Тестирование приложения</a>
...
# <a id="title17">17. Документация к API</a> 
