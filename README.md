...
[10 Загрузка тестовых данных](#title10) / 
[11 Тестирование приложения](#title11) /
...
# <a id="title10">10. Загрузка тестовых данных</a>
...
# <a id="title11">11. Тестирование приложения</a>
...
# <a id="title14">14. Описание файла .flake8</a> 
```angelscript
[flake8]
max-line-length = 119
ignore = E203, W503
...
# <a id="title15">15. Описание файла mypy.ini</a> 
```ini
