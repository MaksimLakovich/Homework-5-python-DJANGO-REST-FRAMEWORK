...
[11. Сигналы](#title11) / 
[12. Загрузка тестовых данных](#title12) / 
...
1) Сигнал `update_course_timestamp()` - для обновления в объекте Course значения поля *updated_at*, если было выполнено обновление объекта Lesson, который входит в данный Курс:
   - *Обработчик сигнала:*
...
# <a id="title12">12. Загрузка тестовых данных</a>
...
# <a id="title18">18. Документация к API</a> 
